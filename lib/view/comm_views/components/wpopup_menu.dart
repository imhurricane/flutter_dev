                              ...
                              children: <Widget>[
                                ...
                                _curPage == 0
                                  ...
                                  child: Container(
                                    ...
                                    height: widget.menuHeight,
                                    child: Image.asset(
                                      'resources/images/left_white.png',
                                      fit: BoxFit.none,
                                    ),
                                  ),
                                ),
                                    ...
                                    child: Image.asset(
                                      (_curPage + 1) *
                                          widget
                                              ._pageMaxChildCount >=
                                          widget.actions.length
                                          ? 'resources/images/right_gray.png'
                                          : 'resources/images/right_white.png',
                                      fit: BoxFit.none,
                                    ),
                                  ),
                                )
...
//    print('childSize.width:'+childSize.width.toString());
//    print('position.left:'+position.left.toString());
//    print('width:'+width.toString());
//    print('_kMenuScreenPadding:'+_kMenuScreenPadding.toString());
